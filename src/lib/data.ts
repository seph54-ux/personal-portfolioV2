...
export const blogPosts: Blog[] = [
  {
    ...
    content: `
      ...
      <div class="not-prose space-y-8 mt-12">
        <section id="codm-story" class="glassmorphic p-6 rounded-lg scroll-mt-32">
        ...
        <section id="mlbb-story" class="glassmorphic p-6 rounded-lg scroll-mt-32">
          <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
        ...
        <section id="bloodstrike-story" class="glassmorphic p-6 rounded-lg scroll-mt-32">
          <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
        ...
        <section id="hok-story" class="glassmorphic p-6 rounded-lg scroll-mt-32">
          <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
        ...
        <section id="minecraft-story" class="glassmorphic p-6 rounded-lg scroll-mt-32">
          <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
      ...
      <div class="not-prose space-y-8">
        <section id="rusted-story" class="glassmorphic p-6 rounded-lg scroll-mt-32">
          <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
        ...
        <section id="cooking-story" class="glassmorphic p-6 rounded-lg scroll-mt-32">
          <div style="display: flex; align-items: center; gap: 1rem; margin-bottom: 1rem;">
